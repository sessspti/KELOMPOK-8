        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gradient-to-br from-green-50 to-yellow-50/50">
            <div class="w-full max-w-md glass-panel p-10 rounded-3xl shadow-xl border border-white/60">
                ...
                <div class="mb-10 text-center lg:text-left">
                    <h2 class="text-3xl font-bold text-gray-900 mb-3">Selamat Datang di Website Kami</h2>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-1">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" class="text-xs font-medium text-green-600 hover:text-green-500 transition-colors">
                                    Lupa sandi?
                                </a>
                            @endif
                        </div>
                ...
                <div class="mt-8 text-center text-sm text-gray-500">
                    Belum punya akun? 
                    <a href="{{ route('register') }}" class="font-medium text-yellow-600 hover:text-yellow-500 transition-colors">
                        Daftar sekarang
                    </a>
                </div>
            </div>
