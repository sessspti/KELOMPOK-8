...
<body class="antialiased bg-gray-50 text-gray-800 selection:bg-green-500 selection:text-white">
    <div class="min-h-screen flex">
        ...
        <div
            class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gradient-to-br from-green-50 to-yellow-50/50">
            <div class="w-full max-w-md glass-panel p-10 rounded-3xl shadow-xl border border-white/60">

                <!-- Mobile Logo -->
                <div class="lg:hidden text-center mb-8">
                    <h1 class="text-4xl font-bold tracking-tight text-green-800">Food<span
                            class="text-yellow-500">Save</span></h1>
                </div>

                <div class="mb-10 text-center lg:text-left">
                    <h2 class="text-3xl font-bold text-gray-900 mb-3">Selamat Datang di <span class="text-green-700">Food</span><span class="text-yellow-500">Save</span></h2>
                    <p class="text-gray-500 text-sm">Silakan masuk menggunakan akun Anda untuk melanjutkan.</p>
                </div>
                        ...
                        <div class="flex justify-between items-center mb-1">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}"
                                    class="text-xs font-medium text-green-600 hover:text-green-500 transition-colors">
                                    Lupa sandi?
                                </a>
                            @endif
                        </div>
