...
@media(max-width:600px){.bento-tracker-grid{grid-template-columns:1fr}}
.tracker-item {
            ...
            <div class="bento-tracker-grid">
                <div class="tracker-item">
                    ...
                    <div class="tracker-value">
                        {{ number_format((float) ($impact->food_saved_kg ?? 0), 1) }} <span class="tracker-unit">Kg</span>
                    </div>
                </div>
                <div class="tracker-item">
                    <div class="tracker-label">
                    ...
                    <div class="tracker-value">
                        {{ number_format((float) ($impact->co2_reduced_kg ?? 0), 1) }} <span class="tracker-unit">Kg</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <template x-for="product in filteredProducts" :key="product.id">
                <div class="pcard" style="flex: 0 0 300px; scroll-snap-align: start;">
                    <div class="pcard-img">
                        ...
                        {{-- ✅ BADGE JUMLAH PORSI HIJAU (pojok kanan atas) — menggantikan bdg-dist 0.5km --}}
                        <div
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                ...
                @empty
                    <div class="bg-white shadow-sm rounded-xl overflow-hidden hover:-translate-y-1 hover:shadow-lg transition-all border border-gray-100 flex flex-col h-full">
                        ...
                        <div class="p-5 flex flex-col flex-grow">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-bold bg-green-100 text-green-800 mb-3 w-max">Keamanan Pangan</span>
                            <h3 class="text-lg font-bold text-gray-900 mb-2 line-clamp-2 leading-snug">Prosedur Keamanan Pangan (Food Safety) untuk Makanan Surplus</h3>
                            <p class="text-sm text-gray-500 line-clamp-2 flex-grow">Panduan lengkap memeriksa kelayakan makanan surplus sebelum didistribusikan kepada penerima manfaat agar tetap aman dikonsumsi.</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white shadow-sm rounded-xl overflow-hidden hover:-translate-y-1 hover:shadow-lg transition-all border border-gray-100 flex flex-col h-full">
                        ...
                        <div class="p-5 flex flex-col flex-grow">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-bold bg-sky-100 text-sky-800 mb-3 w-max">Panduan Distribusi</span>
                            <h3 class="text-lg font-bold text-gray-900 mb-2 line-clamp-2 leading-snug">Cara Mendistribusikan Makanan Cepat Saji agar Tetap Layak Konsumsi</h3>
                            <p class="text-sm text-gray-500 line-clamp-2 flex-grow">Teknik pengemasan, transportasi, dan batas waktu distribusi makanan cepat saji yang aman dari dapur restoran ke tangan penerima.</p>
                        </div>
                    </div>
